...
public class ZaposleniFrame extends JFrame {
		...
		if (btnDodati == null) {
			...
			btnDodati.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					ZaposleniDialog zd = new ZaposleniDialog();
					zd.setVisible(true);
					if (zd.getDialogResult().equalsIgnoreCase("OK")) {
						osveziTabeluZaSve();
						JOptionPane.showMessageDialog(ovaj,
								"Novi zaposleni je uspješno dodan!", "Poruka",
	...
	private JButton getBtnIzmeniti() {
		if (btnIzmeniti == null) {
				...
				public void actionPerformed(ActionEvent e) {
					if (table.getSelectedRow() == -1) {
						...
						Zaposleni odabraniZaposleni = ((ZaposleniTableModel) table
								...
								.getSelectedRow());
						ZaposleniDialog zd = new ZaposleniDialog(odabraniZaposleni);
						zd.setVisible(true);
						if (zd.getDialogResult().equalsIgnoreCase("OK")) {
							osveziTabeluZaSve();
							JOptionPane.showMessageDialog(ovaj,
			...
			btnIzmeniti.setToolTipText("Izmijeniti odabranog zaposlenog");
