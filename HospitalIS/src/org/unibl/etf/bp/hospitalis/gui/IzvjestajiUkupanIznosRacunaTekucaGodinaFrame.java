...
public class IzvjestajiUkupanIznosRacunaTekucaGodinaFrame extends JFrame{
	 ...
	 * Create the frame.
	 */
	public IzvjestajiUkupanIznosRacunaTekucaGodinaFrame() {
		kolone = new Vector<Object>();
		kolone.add("Ukupan iznos računa za tekuću godinu");

		setTitle("Ukupan iznos računa za tekuću godinu");

		podaci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess()
				.ukupanIznosRacunaTekucaGodina();
