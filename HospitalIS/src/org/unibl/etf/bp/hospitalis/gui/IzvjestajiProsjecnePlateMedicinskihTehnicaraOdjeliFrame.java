...
public class IzvjestajiProsjecnePlateMedicinskihTehnicaraOdjeliFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public IzvjestajiProsjecnePlateMedicinskihTehnicaraOdjeliFrame() {
		kolone = new Vector<Object>();
		kolone.add("Naziv odjela");
		kolone.add("Prosječna plata medicinskih tehničara");

		setTitle("Prosječne plate medicinskih tehničara po odjelima");

		podaci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess()
				.prosjecnePlateMedicinskihTehnicaraOdjeli();
